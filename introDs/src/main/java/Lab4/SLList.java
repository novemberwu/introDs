...
public class SLList {
    ...
    // adding an element into the tail of the list
    public void addLast(int x){
        IntNode p = first;
        // I need to travel to the last node of current list
        while(p.next != null){
            p = p.next;
        }
        // at this moment, p.next = null, therefore p is the last node of the list
        p.next = new IntNode(x, null);

        size+=1;

    }
    // this will return the value of the first Node of the SLList
    public int getFirst(){
